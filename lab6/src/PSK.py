...
# Title: Psk
# Generated: Wed May 22 11:21:40 2019
##################################################
...
class PSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for i in xrange(1):
            if len(labels[i]) == 0:
                self.b_qtgui_waterfall_sink_x_0.set_line_label(i, "Data {0}".format(i))
            else:
        ...
        self._b_qtgui_waterfall_sink_x_0_win = sip.wrapinstance(self.b_qtgui_waterfall_sink_x_0.pyqwidget(), Qt.QWidget)
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 0.00025, 0)
        ...
        self.a_qtgui_const_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, "")
        ...
        for i in xrange(1):
            if len(labels[i]) == 0:
                self.a_qtgui_const_sink_x_0.set_line_label(i, "Data {0}".format(i))
            else:
        ...
        self._a_qtgui_const_sink_x_0_win = sip.wrapinstance(self.a_qtgui_const_sink_x_0.pyqwidget(), Qt.QWidget)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.a_qtgui_const_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.b_qtgui_waterfall_sink_x_0, 0))
    ...
    def set_update_per(self, update_per):
        ...
        self.b_qtgui_waterfall_sink_x_0.set_update_time(self.update_per/4)
        self.a_qtgui_const_sink_x_0.set_update_time(self.update_per)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.b_qtgui_waterfall_sink_x_0.set_frequency_range(0, self.samp_rate)
